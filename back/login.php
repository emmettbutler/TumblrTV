...
# require 'class.xhttp.php'; # uncomment if you don't use autoloading
...
<strong>oauth_token</strong>: [hidden]<?php $_SESSION['oauth_token']; ?><br />
<strong>oauth_token_secret</strong>: [hidden]<?php $_SESSION['oauth_token_secret']; ?><br /><br />
<a href="?logout">Log out</a>

<form method="POST">
   <p>Post link to Tumblr</p>
   <input disabled="true" value="Authenticating with Tumblr using OAuth | sudocode" /><br/>
   <input disabled="true" value="http://sudocode.net/article/351/authenticating-with-tumblr-using-oauth-in-php" /><br/>
    <textarea name="description" rows="4" cols="50"></textarea><br />
    <input type="submit" name="postlink" value="Post to Tumblr" />
</form>
